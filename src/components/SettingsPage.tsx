    ...
    <div className="min-h-screen p-6 max-w-4xl mx-auto">
      ...
      <Tabs defaultValue="profile" className="space-y-6">
        ...
        <TabsContent value="profile" className="space-y-6">
          ...
          >
            <Card className="glass border-white/10 p-6">
              <h3 className="text-xl text-white mb-6">Connected Accounts</h3>
                ...
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">alex@gmail.com</p>
                    </div>
                  </div>
                  <Button
                    variant="outline"
          ...
          >
            <Card className="glass border-white/10 p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white">New Followers</p>
                    <p className="text-sm text-gray-400">
        ...
        <TabsContent value="privacy" className="space-y-6">
          ...
          >
            <Card className="glass border-white/10 p-6">
              <h3 className="text-xl text-white mb-6">Privacy & Security</h3>
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white">Private Profile</p>
                    <p className="text-sm text-gray-400">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white">Show GitHub Activity</p>
                    <p className="text-sm text-gray-400">
        ...
        <TabsContent value="appearance" className="space-y-6">
          ...
          >
            <Card className="glass border-white/10 p-6">
              <h3 className="text-xl text-white mb-6">Theme Preferences</h3>
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
