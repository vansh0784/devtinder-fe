...
const PROJECTS = [
  ...
  },
  {
    id: 2,
    name: "API Builder",
    description: "No-code API builder with automatic documentation generation",
    stars: 234,
    forks: 45,
    language: "Node.js",
    color: "#8A2BE2",
      ...
      >
        <Tabs defaultValue="skills" className="space-y-6">
          ...
          <TabsContent value="skills" className="space-y-6">
            ...
            <Card className="glass border-white/10 p-6">
              <h3 className="text-xl text-white mb-4">Interests</h3>
              <div className="flex flex-wrap gap-3">
                {["Web Development", "Open Source", "DevOps", "AI/ML"].map(
                  (interest) => (
                    <Badge
                      key={interest}
                      variant="outline"
