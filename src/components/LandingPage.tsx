    ...
    <div className="min-h-screen overflow-hidden bg-linear-to-br from-[#121212] via-[#1C1C1E] to-[#121212] text-white">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mb-8 max-w-xl text-xl text-gray-400">
                The ultimate social platform for developers to find
                collaborators, share projects, and build the future together.
              </p>
              ...
              <div className="mt-12 flex items-center gap-8">
                <div>
                  <div className="gradient-text text-3xl">10K+</div>
                  <div className="text-sm text-gray-400">Developers</div>
                </div>
                <div className="h-12 w-px bg-white/20" />
                <div>
                  <div className="gradient-text text-3xl">5K+</div>
                  <div className="text-sm text-gray-400">Projects</div>
                </div>
                <div className="h-12 w-px bg-white/20" />
                <div>
                  <div className="gradient-text text-3xl">50+</div>
      ...
      <section id="features" className="scroll-mt-20 px-6 py-20">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <h2 className="mb-4 text-4xl">Why Developers Love DevTinder</h2>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mx-auto max-w-3xl text-xl text-gray-400">
              We're on a mission to revolutionize how developers connect,
          ...
          >
            ...
            <p className="mx-auto mb-8 max-w-3xl text-lg text-gray-400">
              DevTinder was created by a team of passionate developers who
              understand the challenges of finding the right collaborators. We
              combined the best aspects of professional networking, open-source
              collaboration, and modern matchmaking to create a platform that
              makes it easy to find your perfect development partner.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <div className="text-center">
                <div className="gradient-text mb-1 text-2xl">2025</div>
                <div className="text-sm text-gray-400">Founded</div>
              </div>
              <div className="hidden h-12 w-px bg-white/20 sm:block" />
              <div className="text-center">
                <div className="gradient-text mb-1 text-2xl">50+</div>
                <div className="text-sm text-gray-400">Countries</div>
              </div>
              <div className="hidden h-12 w-px bg-white/20 sm:block" />
              <div className="text-center">
                <div className="gradient-text mb-1 text-2xl">10K+</div>
                <div className="text-sm text-gray-400">Active Users</div>
              </div>
              <div className="hidden h-12 w-px bg-white/20 sm:block" />
              <div className="text-center">
                <div className="gradient-text mb-1 text-2xl">5K+</div>
      ...
      <section className="px-6 py-20">
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="mb-4 text-4xl">Ready to start building together?</h2>
            <p className="mb-8 text-xl text-gray-400">
              Join thousands of developers already collaborating on DevTinder
            </p>
            <Button
              size="lg"
